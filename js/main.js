...
function jsonFlickrApi(obj) {
  ...
  var insPics = function() {
    ...
    var picRearrange = function(col) {
      ...
      infiniteScroll(gallery.getPics.bind(gallery));
    };
    ...
    EventUtil.addHandler(container, 'click', lightBox);
  };
...
var gallery = {
  ...
  getPics: function() {
    ...
    script.src = 'https://api.flickr.com/services/rest/?method=flickr.people.getPhotos&api_key=2202999fc9c18d1e5168b73f8cc440de&user_id=14738778%40N03&extras=url_z&per_page=15&page='+ this.pageNum +'&format=json';
...
document.addEventListener('DOMContentLoaded', gallery.getPics.bind(gallery));